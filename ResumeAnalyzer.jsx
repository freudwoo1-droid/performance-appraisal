        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className={`rounded-2xl shadow-lg p-6 sm:p-8 ${isDark ? 'bg-slate-800 border-2 border-slate-700' : 'bg-white'}`}>
            <div className="flex items-center gap-2 mb-4">
              ...
              className={`w-full h-96 p-4 rounded-xl resize-none focus:outline-none transition-colors font-mono text-sm ${
                isDark 
            ...
            <button
              ...
              className={`w-full mt-4 font-bold py-3 px-6 rounded-xl transition-colors disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg ${
                isDark
